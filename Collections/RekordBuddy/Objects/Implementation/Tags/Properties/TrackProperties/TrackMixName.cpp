...
#include <RekordBuddyCollection/Implementation/Tags/Properties/TrackProperties/TrackMixName.hpp>
...
inline constexpr bool operator==(const PersistentTrackMixName& first, const PersistentTrackMixName& second) noexcept
{
...
#define NXA_OBJECT_CLASS                                        TrackMixName
...
TrackMixName TrackMixName::withValueInCollection(const String& value, Collection& collection)
{
    return TrackMixName{ StringPropertyInternal::stringPropertyWithValueInCollection<PersistentTrackMixName>(value, collection) };
}

// -- Instance Methods

String TrackMixName::value() const
{
