...
#include <RekordBuddyCollection/Implementation/Tags/Properties/TrackProperties/TrackGrouping.hpp>
...
inline constexpr bool operator==(const PersistentTrackGrouping& first, const PersistentTrackGrouping& second) noexcept
{
...
#define NXA_OBJECT_CLASS                                        TrackGrouping
...
TrackGrouping TrackGrouping::withValueInCollection(const String& value, Collection& collection)
{
    return TrackGrouping{ StringPropertyInternal::stringPropertyWithValueInCollection<PersistentTrackGrouping>(value, collection) };
}

// -- Instance Methods

String TrackGrouping::value() const
{
