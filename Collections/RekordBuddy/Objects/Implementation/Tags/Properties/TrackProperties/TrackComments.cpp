...
#include <RekordBuddyCollection/Implementation/Tags/Properties/TrackProperties/TrackComments.hpp>
...
inline constexpr bool operator==(const PersistentTrackComments& first, const PersistentTrackComments& second) noexcept
{
...
#define NXA_OBJECT_CLASS                                        TrackComments
...
TrackComments TrackComments::withValueInCollection(const String& value, Collection& collection)
{
    return TrackComments{ StringPropertyInternal::stringPropertyWithValueInCollection<PersistentTrackComments>(value, collection) };
}

// -- Instance Methods

String TrackComments::value() const
{
