...
inline constexpr bool operator==(const PersistentTrackLength& first, const PersistentTrackLength& second) noexcept
{
...
#define NXA_OBJECT_CLASS                                        TrackLength
...
TrackLength TrackLength::withValueInCollection(DecimalNumber value, Collection& collection)
{
    return TrackLength{ DecimalPropertyInternal::decimalPropertyWithValueInCollection<PersistentTrackLength>(value, collection) };
}

// -- Instance Methods

DecimalNumber TrackLength::valueInSeconds()
{
