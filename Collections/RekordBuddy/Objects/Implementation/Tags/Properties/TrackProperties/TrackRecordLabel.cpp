...
#include <RekordBuddyCollection/Implementation/Tags/Properties/TrackProperties/TrackRecordLabel.hpp>
...
inline constexpr bool operator==(const PersistentTrackRecordLabel& first, const PersistentTrackRecordLabel& second) noexcept
{
...
#define NXA_OBJECT_CLASS                                        TrackRecordLabel
...
TrackRecordLabel TrackRecordLabel::withValueInCollection(const String& value, Collection& collection)
{
    return TrackRecordLabel{ StringPropertyInternal::stringPropertyWithValueInCollection<PersistentTrackRecordLabel>(value, collection) };
}

// -- Instance Methods

String TrackRecordLabel::value() const
{
