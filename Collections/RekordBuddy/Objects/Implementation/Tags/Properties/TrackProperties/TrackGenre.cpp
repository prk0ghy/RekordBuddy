...
#include <RekordBuddyCollection/Implementation/Tags/Properties/TrackProperties/TrackGenre.hpp>
...
inline constexpr bool operator==(const PersistentTrackGenre& first, const PersistentTrackGenre& second) noexcept
{
...
#define NXA_OBJECT_CLASS                                        TrackGenre
...
TrackGenre TrackGenre::withValueInCollection(const String& value, Collection& collection)
{
    return TrackGenre{ StringPropertyInternal::stringPropertyWithValueInCollection<PersistentTrackGenre>(value, collection) };
}

// -- Instance Methods

String TrackGenre::value() const
{
