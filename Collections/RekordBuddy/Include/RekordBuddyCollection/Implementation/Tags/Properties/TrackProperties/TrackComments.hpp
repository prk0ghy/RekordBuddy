...
// -- Public Interface
class TrackComments : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::Comments;

    // -- Factory Methods
    static TrackComments withValueInCollection(const String&, Collection&);
