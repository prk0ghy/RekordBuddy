...
// -- Public Interface
class TrackDiscNumber : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::DiscNumber;

    // -- Factory Methods
    static TrackDiscNumber withValueInCollection(count, Collection&);
