...
inline static String p_stringValueForTrackLength(const PersistentTrackLength& trackLength)
{
    return Time::stringValueAsTimeRepresentationFromMilliseconds((trackLength.decimalValue() * 1000).asInteger());
}
