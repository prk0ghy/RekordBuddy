...
// -- Public Interface
class TrackSampleRate : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::SampleRateInHertz;

    // -- Factory Methods
    static TrackSampleRate withValueInCollection(count, Collection&);

    // -- Instance Methods
    count valueInHertz() const;
};
