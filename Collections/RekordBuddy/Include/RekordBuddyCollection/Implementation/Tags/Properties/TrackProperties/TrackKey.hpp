...
// -- Public Interface
class TrackKey : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::MusicalKey;

    // -- Class Methods
    static Array<TrackKey> musicalKeysInCollection(Collection&);

    // -- Factory Methods
    static TrackKey withValueInCollection(Common::MusicalKey::Value, Collection&);

    // -- Instance Methods
    Common::MusicalKey::Value value() const;

    Array<ObjectID> trackObjectIDs() const;
    Array<NotNull<const RekordBuddy::MutableTrack*>> tracks() const;

    String stringValue() const;
    String stringValueForNotation(Common::MusicalKey::Notation) const;
};
