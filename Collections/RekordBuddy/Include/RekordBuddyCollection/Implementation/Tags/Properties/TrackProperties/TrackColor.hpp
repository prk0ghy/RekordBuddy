...
// -- Public Interface
class TrackColor : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::Color;

    // -- Factory Methods
    static TrackColor withValueInCollection(const Color&, Collection&);
