...
// -- Public Interface
class TrackRating : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::Rating;

    // -- Factory Methods
    static TrackRating withValueInCollection(count, Collection&);

    // -- Instance Methods
    Optional<Common::TrackRating> maybeValue() const;
