...
// -- Public Interface
class TrackFileType : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::FileType;

    // -- Factory Methods
    static TrackFileType withValueInCollection(AudioFileType, Collection&);

    // -- Instance Methods
    AudioFileType value() const;
};
