...
// -- Public Interface
class TrackDateReleased : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::DateReleased;

    // -- Factory Methods
    static Optional<TrackDateReleased> maybeWithValueInCollection(const String&, Collection&);
