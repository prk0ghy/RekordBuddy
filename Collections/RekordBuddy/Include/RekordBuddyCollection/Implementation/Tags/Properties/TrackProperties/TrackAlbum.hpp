...
// -- Public Interface
class TrackAlbum : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::Album;

    // -- Factory Methods
    static TrackAlbum withValueInCollection(const String&, Collection&);

    // -- Instance Methods
    String value() const;

    Optional<count> maybeNumberOfTracks() const;
    void setNumberOfTracks(Optional<count>);
};
