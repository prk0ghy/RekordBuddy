...
inline static String p_stringValueForTrackBeatGrisLockedFlag(const PersistentTrackBeatGridLockedFlag& flag)
{
    return String{ flag.integerValue() ? "Grid Locked" : "Grid Unlocked" };
}
