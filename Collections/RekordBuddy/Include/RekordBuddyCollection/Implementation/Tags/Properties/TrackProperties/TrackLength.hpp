...
// -- Public Interface
class TrackLength : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::LengthInSeconds;

    // -- Factory Methods
    static TrackLength withValueInCollection(DecimalNumber /* In Seconds */, Collection&);

    // -- Instance Methods
    DecimalNumber valueInSeconds();
};
