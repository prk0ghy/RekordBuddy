...
// -- Public Interface
class TrackGrouping : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::Grouping;

    // -- Factory Methods
    static TrackGrouping withValueInCollection(const String&, Collection&);
