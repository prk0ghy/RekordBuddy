...
inline static String p_stringValueForTrackBpm(const PersistentTrackBpm& trackBpm)
{
    return trackBpm.decimalValue().asStringWithFractionDigitsBetween(0, 2, DecimalNumber::AndUsingRoundingPolicy::CloserToZero));
}
