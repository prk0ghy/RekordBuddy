...
// -- Public Interface
class TrackGenre : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::Genre;

    // -- Factory Methods
    static TrackGenre withValueInCollection(const String&, Collection&);
