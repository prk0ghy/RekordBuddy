...
// -- Public Interface
class TrackBeatGridLockedFlag : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::BeatGridLockedFlag;

    // -- Factory Methods
    static TrackBeatGridLockedFlag withValueInCollection(boolean, Collection&);
