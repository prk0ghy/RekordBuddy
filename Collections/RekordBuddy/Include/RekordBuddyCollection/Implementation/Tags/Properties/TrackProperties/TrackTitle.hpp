...
// -- Public Interface
class TrackTitle : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::Title;

    // -- Factory Methods
    static TrackTitle withValueInCollection(const String&, Collection&);
