...
// -- Public Interface
class TrackFileSize : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::FileSize;

    // -- Factory Methods
    static TrackFileSize withValueInCollection(count, Collection&);

    // -- Instance Methods
    count valueInBytes() const;
};
