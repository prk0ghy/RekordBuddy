...
// -- Public Interface
class TrackBpm : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::BeatsPerMinute;

    // -- Factory Methods
    static TrackBpm withValueInCollection(const DecimalNumber&, Collection&);
    static TrackBpm withValueInCollection(const String&, Collection&);

    // -- Instance Methods
    DecimalNumber valueInBeatsPerMinute() const;
};
