...
// -- Public Interface
class TrackBitDepth : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::BitDepthInBits;

    // -- Factory Methods
    static TrackBitDepth withValueInCollection(count, Collection&);

    // -- Instance Methods
    count valueInBits() const;
};
