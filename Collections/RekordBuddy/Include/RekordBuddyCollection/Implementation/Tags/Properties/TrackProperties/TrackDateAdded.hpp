...
// -- Public Interface
class TrackDateAdded : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::DateAdded;

    // -- Factory Methods
    static Optional<TrackDateAdded> maybeWithValueInCollection(const String&, Collection&);
