...
// -- Public Interface
class TrackMixName : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::MixName;

    // -- Factory Methods
    static TrackMixName withValueInCollection(const String&, Collection&);
