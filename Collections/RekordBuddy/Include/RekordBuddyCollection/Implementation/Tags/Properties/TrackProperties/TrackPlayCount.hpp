...
// -- Public Interface
class TrackPlayCount : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::PlayCount;

    // -- Factory Methods
    static TrackPlayCount withValueInCollection(count, Collection&);
