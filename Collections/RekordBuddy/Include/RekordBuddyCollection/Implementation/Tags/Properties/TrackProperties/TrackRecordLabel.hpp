...
// -- Public Interface
class TrackRecordLabel : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::RecordLabel;

    // -- Factory Methods
    static TrackRecordLabel withValueInCollection(const String&, Collection&);
