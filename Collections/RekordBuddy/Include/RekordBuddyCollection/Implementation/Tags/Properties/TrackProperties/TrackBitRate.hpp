...
// -- Public Interface
class TrackBitRate : public NXA_OBJECT
{
...
public:
    ...
    static constexpr Common::Property::TypeID typeID = Common::Property::TypeID::BitRateInKiloBitsPerSecond;

    // -- Factory Methods
    static TrackBitRate withValueInCollection(count, Collection&);

    // -- Instance Methods
    count valueInBitsPerSecond();
};
