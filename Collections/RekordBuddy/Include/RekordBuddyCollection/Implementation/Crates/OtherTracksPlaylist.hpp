...
// -- Public Interface
class OtherTracksPlaylist : public NXA_OBJECT
{
    #include <Base/ObjectDeclaration.ipp>

public:
    // -- Factory Methods
    static OtherTracksPlaylist withNameInCollection(const String&, Collection&);

    // -- Class Methods
    static void addOrUpdateOtherTracksPlaylistNamedIn(const String&, Playlist&);
