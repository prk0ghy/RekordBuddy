...
inline constexpr bool operator==(const RekordBuddy::CollectionImplementation::PersistentSmartPlaylist& first,
                                 const RekordBuddy::CollectionImplementation::PersistentSmartPlaylist& second) noexcept
{
...
// -- Private Functions
inline void p_deleteSmartPlaylistFromCollection(PersistentSmartPlaylist& playlist)
{
...
void p_updateSmartPlaylistSmartContent(SmartPlaylist&, PersistentSmartPlaylist&, Crate::AndUpdateClones);
