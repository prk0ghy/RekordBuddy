...
inline constexpr bool operator==(const RekordBuddy::CollectionImplementation::PersistentAllTracksPlaylist& first,
                                 const RekordBuddy::CollectionImplementation::PersistentAllTracksPlaylist& second) noexcept
{
...
inline void p_deleteAllTracksPlaylistFromCollection(PersistentAllTracksPlaylist& playlist)
{
