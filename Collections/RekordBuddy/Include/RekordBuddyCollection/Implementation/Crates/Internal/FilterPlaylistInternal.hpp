...
inline constexpr bool operator==(const RekordBuddy::CollectionImplementation::PersistentFilterPlaylist& first,
                                 const RekordBuddy::CollectionImplementation::PersistentFilterPlaylist& second) noexcept
{
...
// -- Private Functions
Playlist p_sourcePlaylistFor(std::shared_ptr<PersistentCrate>&);

inline void p_deleteFilterPlaylistFromCollection(PersistentFilterPlaylist& playlist)
{
...
void p_updateFilterPlaylistSmartContent(FilterPlaylist&, PersistentFilterPlaylist&);

Playlist p_topParentPlaylistFor(std::shared_ptr<PersistentSortingPlaylist>);
