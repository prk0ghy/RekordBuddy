...
inline constexpr bool operator==(const RekordBuddy::CollectionImplementation::PersistentRootFolder& first,
                                 const RekordBuddy::CollectionImplementation::PersistentRootFolder& second) noexcept
{
...
// -- Private Functions
inline void p_deleteRootFolderFromCollection(PersistentRootFolder& folder)
{
    ...
    p_deleteFolderFromCollection(folder);
}
