...
inline constexpr bool operator==(const RekordBuddy::CollectionImplementation::PersistentCrateClone& first,
                                 const RekordBuddy::CollectionImplementation::PersistentCrateClone& second) noexcept
{
...
// -- Private Functions
void p_deleteCrateCloneFromCollection(PersistentCrateClone&);
