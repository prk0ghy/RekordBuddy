...
// -- Public Interface
class MarkerUtility final
{
    // -- Friends
    friend class CueMarker;
    friend class LoopMarker;
    friend class GridMarker;
...
protected:
    ...
    inline static void p_deleteFromCollection(CollectionImplementation::PersistentMarker& marker)
    {
