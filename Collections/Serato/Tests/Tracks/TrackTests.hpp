...
#include "../Tags/ObjectTagTests.hpp"

#include <Base/Test.hpp>

namespace NxA { namespace Serato { namespace CollectionImplementation {

class TrackTests : public NxA::Test
{
public:
    // -- Class Methods
    static Track testTrackInCollection(Pointer<Serato::MutableCollection> inCollection)
    {
        return { ObjectTagTests::testObjectTag(), inCollection, Track::p_isProtected };
    }
