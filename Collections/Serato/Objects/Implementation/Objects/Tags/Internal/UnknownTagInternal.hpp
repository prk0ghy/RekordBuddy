...
// -- Internal Interface
class UnknownTagInternal : public NXA_OBJECT_INTERNAL_BASE_CLASS
{
    #include <Base/ObjectInternal.ipp>

public:
    // -- Constructors & Destructors
    UnknownTagInternal() = default;
    UnknownTagInternal(const UnknownTagInternal&) = default;
    UnknownTagInternal(UnknownTagInternal&&) = default;
    virtual ~UnknownTagInternal() = default;

    // -- Instance Variables
    Blob value;

    // -- Operators
    bool operator==(const UnknownTagInternal& other) const
    {
