...
// -- Public Interface
class UInteger16Tag : public NXA_OBJECT
{
...
public:
    ...
    // -- Factory Methods
    static UInteger16Tag tagWithMemoryAt(NotNull<const byte*> tagAddress);
    static UInteger16Tag tagWithIdentifierAndValue(uinteger32 identifier, uinteger16 value);

    // -- Instance Methods
    uinteger16 value() const;
};
