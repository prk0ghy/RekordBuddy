...
// -- Public Interface
class VersionTag : public NXA_OBJECT
{
...
public:
    ...
    // -- Factory Methods
    static VersionTag tagWithMemoryAt(NotNull<const byte*> tagAddress);
    static VersionTag tagWithIdentifierAndValue(uinteger32 identifier, const String& value);
};
