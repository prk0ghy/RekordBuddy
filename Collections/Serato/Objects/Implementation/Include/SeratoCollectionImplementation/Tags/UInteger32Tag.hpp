...
// -- Public Interface
class UInteger32Tag : public NXA_OBJECT
{
...
public:
    ...
    // -- Factory Methods
    static UInteger32Tag tagWithMemoryAt(NotNull<const byte*> tagAddress);
    static UInteger32Tag tagWithIdentifierAndValue(uinteger32 identifier, uinteger32 value);

    // -- Instance Methods
    uinteger32 value() const;
};
