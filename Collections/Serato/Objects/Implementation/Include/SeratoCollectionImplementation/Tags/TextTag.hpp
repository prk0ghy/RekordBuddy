...
// -- Public Interface
class TextTag : public NXA_OBJECT
{
    #include <Base/ObjectDeclaration.ipp>

    friend class PathTag;
    friend class VersionTag;
...
public:
    ...
    // -- Factory Methods
    static TextTag tagWithMemoryAt(NotNull<const byte*>);
    static TextTag tagWithIdentifierAndValue(uinteger32, const String&);
