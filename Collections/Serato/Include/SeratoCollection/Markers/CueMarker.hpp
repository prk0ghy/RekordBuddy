...
class CueMarker final : public Common::CueMarker
{
    ...
    CueMarker(SeratoCueMarker&& from) : p_seratoCueMarker{ std::move(from) } { }

    // -- Private Instance Variables
    SeratoCueMarker p_seratoCueMarker;
...
public:
    ...
    {
        return DecimalNumber::withIntegerAndExponant(this->p_seratoCueMarker.positionInMilliseconds(), -3);
    }
    ...
    {
        auto hotCueIndex = this->p_seratoCueMarker.index();
...
class MutableCueMarker final : public Common::MutableCueMarker
{
    ...
    friend class SeratoCueMarkerTests;
#endif

    // -- Private Instance Variables
    Serato::CueMarker p_marker;
...
public:
    // -- Constructors & Destructors
    MutableCueMarker(SeratoCueMarker&& from,
    ...
    // -- Instance Methods
    inline const Serato::CueMarker& asImmutableReference() const
    {
    ...
    {
        return this->p_marker.p_seratoCueMarker;
    }
};
