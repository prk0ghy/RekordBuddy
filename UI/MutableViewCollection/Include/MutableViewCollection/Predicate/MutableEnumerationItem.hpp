...
class MutableEnumerationItem : public AbstractEnumerationItem, MutablePredicate
{
public:
    MutableEnumerationItem(ChoiceData, const Common::TrackPredicate& withPredicate);
