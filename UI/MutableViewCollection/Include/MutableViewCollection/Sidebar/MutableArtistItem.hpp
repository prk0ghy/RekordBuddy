...
class MutableArtistItem : public SidebarItem
{
    NotNull<Common::MutableArtist*> p_artist;
    mutable Optional<Shared<AbstractTrackListNode>> p_treeCache;

public:
    MutableArtistItem(NotNull<SidebarModel*>, SidebarItem*, WorkQueue&, NotNull<Common::MutableArtist*>);
