...
class MutableKeysHeader : public SidebarItem
{
    NotNull<Common::MutableCollection*> p_collection;
    mutable Optional<Array<Unique<Common::MutableMusicalKey>>> p_keys;
...
public:
    MutableKeysHeader(NotNull<SidebarModel*>, SidebarItem* parent, WorkQueue&, NotNull<Common::MutableCollection*>);
