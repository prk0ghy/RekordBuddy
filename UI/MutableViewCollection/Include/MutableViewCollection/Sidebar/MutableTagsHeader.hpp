...
class MutableTagsHeader : public SidebarItem
{
    NotNull<Common::MutableCollection*> p_collection;
    mutable Optional<Array<Unique<Common::MutableTag>>> p_tags;
...
public:
    MutableTagsHeader(NotNull<SidebarModel*>, SidebarItem*, WorkQueue&, NotNull<Common::MutableCollection*>);
