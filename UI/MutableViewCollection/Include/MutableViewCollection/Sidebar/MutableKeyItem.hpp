...
class MutableKeyItem : public SidebarItem
{
    NotNull<Common::MutableMusicalKey*> p_key;
    mutable Optional<Shared<AbstractTrackListNode>> p_treeCache;

public:
    MutableKeyItem(NotNull<SidebarModel*>, SidebarItem*, WorkQueue&, NotNull<Common::MutableMusicalKey*>);
