...
class MutableSmartPlaylistItem : public AbstractCrateItem
{
    NotNull<Common::MutableSmartPlaylist*> p_smartPlaylist;
...
public:
    MutableSmartPlaylistItem() = delete;
    explicit MutableSmartPlaylistItem(NotNull<SidebarModel*>, AbstractCrateItem*, WorkQueue&, NotNull<Common::MutableSmartPlaylist*>);
    ~MutableSmartPlaylistItem() override = default;
    ...
    NotNull<const Common::MutableSmartPlaylist*> getPlaylist() const;
    NotNull<Common::MutableSmartPlaylist*> getPlaylist();
