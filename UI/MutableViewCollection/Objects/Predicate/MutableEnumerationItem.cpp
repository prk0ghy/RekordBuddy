...
MutableEnumerationItem::MutableEnumerationItem(ChoiceData data, const TrackPredicate& withPredicate)
...
Optional<TrackPredicate> MutableEnumerationItem::asTrackPredicate() const
{
