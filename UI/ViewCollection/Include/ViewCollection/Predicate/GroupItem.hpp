...
class GroupItem : public AbstractGroupItem, public Predicate
{
protected:
...
public:
    GroupItem(ChoiceData, std::list<std::unique_ptr<AbstractPredicateItem>>&&, GroupMatchMethod);
    GroupItem(ChoiceData rule, const Optional<Common::TrackPredicate>& withPredicate);
