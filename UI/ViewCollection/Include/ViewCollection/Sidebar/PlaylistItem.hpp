...
class PlaylistItem : public AbstractCrateItem
{
    NotNull<const Common::Playlist*> p_playlist;
...
public:
    PlaylistItem() = delete;
    explicit PlaylistItem(NotNull<SidebarModel*>, AbstractCrateItem*, WorkQueue&, NotNull<const Common::Playlist*>);
    ...
    NotNull<const Common::Playlist*> getPlaylist() const;
