...
class FolderItem : public AbstractCrateItem
{
    NotNull<const Common::Folder*> p_folder;
...
public:
    FolderItem() = delete;
    FolderItem(NotNull<SidebarModel*>, SidebarItem*, WorkQueue&, NotNull<const Common::Folder*>);
    ~FolderItem() override = default;

    NotNull<const Common::Folder*> getFolder() const;
