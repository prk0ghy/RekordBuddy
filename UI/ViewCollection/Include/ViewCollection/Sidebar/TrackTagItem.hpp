...
class TrackTagItem : public SidebarItem
{
    NotNull<Common::Tag*> p_tag;
    mutable Optional<Array<Unique<Common::Tag>>> p_children;
...
public:
    TrackTagItem(NotNull<SidebarModel*>, SidebarItem*, WorkQueue&, NotNull<Common::Tag*>);
