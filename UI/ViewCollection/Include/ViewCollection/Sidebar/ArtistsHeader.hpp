...
class ArtistsHeader : public SidebarItem
{
    NotNull<Common::Collection*> p_collection;
    mutable Optional<Array<Unique<Common::Artist>>> p_artists;
...
public:
    ArtistsHeader(NotNull<SidebarModel*>, SidebarItem*, WorkQueue&, NotNull<Common::Collection*>);
