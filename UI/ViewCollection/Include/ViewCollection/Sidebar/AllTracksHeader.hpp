...
class MutablePlaylists;

}

namespace RekordBuddy {

class AllTracksHeader : public SidebarItem
{
    NotNull<const Common::Collection*> p_collection;
    Optional<NotNull<const Common::Playlist*>> p_maybeAllTracksPlaylist;
...
public:
    AllTracksHeader(NotNull<SidebarModel*>, SidebarItem*, WorkQueue&, NotNull<const Common::Collection*>);
