...
class NumberMatchWidget : public ItemRuleWidget<AbstractNumberItem>
{
    Q_OBJECT
    void setupUi();

public:
    explicit NumberMatchWidget(NotNull<AbstractPredicateItem*> withItem, QWidget* parent = nullptr);
