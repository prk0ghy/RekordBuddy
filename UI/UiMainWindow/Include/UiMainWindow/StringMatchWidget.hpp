...
class StringMatchWidget : public ItemRuleWidget<AbstractStringItem>
{
    Q_OBJECT
    void setupUi();

public:
    StringMatchWidget(NotNull<AbstractPredicateItem*> withItem, QWidget* parent);
